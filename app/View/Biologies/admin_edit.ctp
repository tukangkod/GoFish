...
<?php echo $this->Form->create('Biology'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Biology'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Biology.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Biology.id'))); ?></li>
