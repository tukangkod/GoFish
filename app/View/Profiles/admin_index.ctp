<div class="profiles index">
	...
	<tr>
		...
		<td><?php echo h($profile['Profile']['website']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['phone']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['address']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($profile['Country']['name'], array('controller' => 'countries', 'action' => 'view', $profile['Country']['id'])); ?>
		</td>
		<td><?php echo h($profile['Profile']['comment']); ?>&nbsp;</td>
		<td class="actions">
